...
- (NSString *)modelNameForModelIdentifier:(NSString *)modelIdentifier
{
    ...
    if ([modelIdentifier isEqualToString:@"iPhone9,1"])    return @"iPhone 7";      //国行、日版、港行iPhone 7
    if ([modelIdentifier isEqualToString:@"iPhone9,3"])    return @"iPhone 7";     //美版、台版iPhone 7
    if ([modelIdentifier isEqualToString:@"iPhone9,2"])    return @"iPhone 7 Plus"; //港行、国行iPhone 7 Plus
    if ([modelIdentifier isEqualToString:@"iPhone9,4"])    return @"iPhone 7 Plus"; //美版、台版iPhone 7 Plus
    if ([modelIdentifier isEqualToString:@"iPhone10,1"])   return @"iPhone 8";      //国行(A1863)、日行(A1906)
    if ([modelIdentifier isEqualToString:@"iPhone10,4"])   return @"iPhone 8";      //美版(Global/A1905)
    if ([modelIdentifier isEqualToString:@"iPhone10,2"])   return @"iPhone 8 Plus"; //国行(A1864)、日行(A1898)
    if ([modelIdentifier isEqualToString:@"iPhone10,5"])   return @"iPhone 8 Plus"; //美版(Global/A1897)
    if ([modelIdentifier isEqualToString:@"iPhone10,3"])   return @"iPhone X";      //国行(A1865)、日行(A1902)
    if ([modelIdentifier isEqualToString:@"iPhone10,6"])   return @"iPhone X";      //美版(Global/A1901)
    ...
    if ([modelIdentifier isEqualToString:@"iPad4,4"])      return @"iPad mini 2 (Wi-Fi)";
    if ([modelIdentifier isEqualToString:@"iPad4,5"])      return @"iPad mini 2 (Cellular)";
    if ([modelIdentifier isEqualToString:@"iPad4,6"])      return @"iPad mini 2 (Cellular)";
    if ([modelIdentifier isEqualToString:@"iPad4,7"])      return @"iPad mini 3 (Wi-Fi)";
    ...
    if ([modelIdentifier isEqualToString:@"iPad5,1"])      return @"iPad mini 4 (Cellular)";
    if ([modelIdentifier isEqualToString:@"iPad5,2"])      return @"iPad mini 4 (Cellular)";
    if ([modelIdentifier isEqualToString:@"iPad6,3"])      return @"iPad pro 9.7";
    if ([modelIdentifier isEqualToString:@"iPad6,4"])      return @"iPad pro 9.7";
    if ([modelIdentifier isEqualToString:@"iPad6,7"])      return @"iPad pro 12.9";
    if ([modelIdentifier isEqualToString:@"iPad6,8"])      return @"iPad pro 12.9";
    if ([modelIdentifier isEqualToString:@"iPad6,11"])    return @"iPad 5 (WiFi)";
    if ([modelIdentifier isEqualToString:@"iPad6,12"])    return @"iPad 5 (Cellular)";
    if ([modelIdentifier isEqualToString:@"iPad7,1"])     return @"iPad Pro 12.9 (WiFi)";
    if ([modelIdentifier isEqualToString:@"iPad7,2"])     return @"iPad Pro 12.9 (Cellular)";
    if ([modelIdentifier isEqualToString:@"iPad7,3"])     return @"iPad Pro 10.5 (WiFi)";
...
- (BOOL)isIphoneXSeries{
    ...
    if (375 == screenSize.width && 812 == screenSize.height) {
        return YES;
    } else {
        return NO;
    }
