...
- (void)layoutSubviews
{
    ...
    self.btnSelect.frame = CGRectMake(GetViewWidth(self.contentView)-28, GetViewHeight(self.contentView)-28, 23, 23);
...
- (UIButton *)btnSelect
{
    if (!_btnSelect) {
        ...
        _btnSelect.frame = CGRectMake(GetViewWidth(self.contentView)-28, GetViewHeight(self.contentView)-28, 23, 23);
        [_btnSelect setBackgroundImage:[UIImage imageNamed:@"icon_original_circle.png"] forState:UIControlStateNormal];
        [_btnSelect setBackgroundImage:[UIImage imageNamed:@"icon_selected.png"] forState:UIControlStateSelected];
