...
typedef void(^ZLPhotoCompletBlock)();

@interface ZLPhotoActionSheet : UIView

@property (nonatomic, weak) UIViewController *sender;

@property (nonatomic, copy) ZLPhotoCompletBlock completBlock;

@property (nonatomic, copy) FYBlock otherBlock;  //点击其他按钮回调
...
/**
 原来选中的asset对象的数组 index  拍照时替换  -1时不处理
 */
